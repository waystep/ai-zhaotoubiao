  ...
  outputSchema: z.object({
    documents: z.array(
      z.object({
        ...
        reviewItemsCount: z.number().optional().describe("审查项数量"),
        responseItemsCount: z.number().optional().describe("响应项数量"),
    ...
    try {
      ...
      return {
        documents: docs.map(doc => ({
          ...
          reviewItemsCount: doc.reviewItemsCount || 0,
          responseItemsCount: doc.responseItemsCount || 0,
